...
module.exports = {
	...
	description: 'Ajouter un compte à un service.', // Command description displays in the help command
	...
	execute(message, args) {
        ...
        if (!service) {
            return message.channel.send(
                ...
                .setDescription('Vous devez spécifier un compte!')
                .addField('Par example', `${config.prefix}${this.name} **disney** apple`)
        ...
        fs.appendFile(filePath, `${os.EOL}${args[1]}`, function (error) {
            ...
            message.channel.send(
                ...
                .setTitle('Compte ajouter!')
                .setDescription(`Rajoutez avec succes \`${args[1]}\` rendre des comptes à\`${args[0]}\` service!`)
